// Taken from https://github.com/software-mansion/react-native-reanimated/blob/master/src/reanimated2/Colors.ts
...
const interpolateColorsRGB = (value: number, inputRange: readonly number[], colors: readonly number[]) => {
